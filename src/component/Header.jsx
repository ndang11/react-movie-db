  ...
  return (
    <div>
      <div className="container">
        <div className="title" style={{backgroundImage: `linear-gradient(to top,(rgb(0,0,0), rgba(29,27,26, 0.61)),url(${style={{`linear-gradient(to top,(rgb(0,0,0), rgba(29,27,26, 0.61)),url(${background.url})`,}}>
            <div className="rank">CBFC:U/A</div>
            <span>Action. Adventure. 2h 28m</span>
          </div>
        </div>
        <p>
          When a spell goes wrong, dangerous foes from other<br></br> worlds
          start to appear, forcing Peter to discover what it<br></br> truly
