...
export default function Action({redirectTo}) {
    const url = 'https://api.themoviedb.org/3/discover/movie?api_key=17725e2bc6fdf0fc90364efc161372e2&with_genres=28&page=4'
    ...
    return (
        <>
            <div className="action" style={{ color: '#fff' }}>
